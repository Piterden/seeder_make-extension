<?php namespace Defr\SeederMakeExtension\Database\Seeder\Console;

use Anomaly\Streams\Platform\Addon\Command\GetAddon;
use Anomaly\Streams\Platform\Stream\Command\GetStreams;
use Anomaly\Streams\Platform\Stream\StreamCollection;
use Defr\SeederMakeExtension\Addon\Console\Command\WriteAddonSeeder;
use Defr\SeederMakeExtension\Stream\Console\Command\WriteEntitySeeder;
...
class SeederMakeCommand extends \Illuminate\Console\Command
{
    ...
    public function fire()
    {
        ...
        $streams->each(function ($stream) use ($addon)
        {
            $slug = $stream->getSlug();
